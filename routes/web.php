...
Route::middleware('auth')->group(function(){
    ...
    Route::get('user-detail/{slug}', [AdminController::class, 'usersDetail'])->middleware('only_admin');
    Route::get('users-approved/{slug}', [AdminController::class, 'usersApproved']);
    //hapus data
